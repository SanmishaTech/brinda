      ...
      <Card className="mx-auto mt-6 sm:mt-10">
        <CardContent>
          ...
          {isLoading ? (
            ...
            <div className="overflow-x-auto">
              <Table>
                <TableHeader>
                  <TableRow>
                    <TableHead
                      onClick={() => handleSort("repurchaseDate")}
                      className="cursor-pointer max-w-[250px] break-words whitespace-normal"
                    >
                      <div className="flex items-center">
                        <span>Repurchase Date</span>
                        {sortBy === "repurchaseDate" && (
                          <span className="ml-1">
                            {sortOrder === "asc" ? (
                              <ChevronUp size={16} />
                            ) : (
                ...
                <TableBody>
                  {repurchases.map((repurchase) => (
                    <TableRow key={repurchase.id}>
                      <TableCell className="max-w-[250px] break-words whitespace-normal">
                        {repurchase.repurchaseDate
                          ? dayjs(repurchase.repurchaseDate).format(
                              "DD/MM/YYYY hh:mm:ss A"
                            )
                          : "N/A"}
                      </TableCell>
                      <TableCell className="max-w-[250px] break-words whitespace-normal">
                        {repurchase.invoiceNumber || "N/A"}
                      </TableCell>
                      <TableCell className="max-w-[250px] break-words whitespace-normal">
                        {formatCurrency(repurchase.totalAmountWithoutGst) ||
                          "N/A"}
                      </TableCell>
                      <TableCell>
                        {formatCurrency(repurchase.totalGstAmount) || "N/A"}
                      </TableCell>
                      <TableCell>
                        {formatCurrency(repurchase.totalAmountWithGst) || "N/A"}
                      </TableCell>
                      <TableCell>
            ...
            <div className="text-center">No Repurchase Details Found.</div>
          )}
        </CardContent>
      </Card>
    </div>
...
export default RepurchaseHistoryList;
