...
const fetchList = async (
  ...
  const response = await get(
    `/reward-payouts/admin-paid-reward-payouts?page=${page}&sortBy=${sortBy}&sortOrder=${sortOrder}&search=${search}&limit=${recordsPerPage}`
  );
  return response;
};

const AdminPaidRewardList = () => {
  ...
  return (
    <div className="mt-2 p-4 sm:p-6">
      <h1 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">
        Rewards Commission Paid Details
      </h1>
        ...
        <CardContent>
          ...
          {isLoading ? (
            ...
            <div className="text-center text-red-500">
              Failed to load reward commission paid details list.
            </div>
...
export default AdminPaidRewardList;
