...
const fetchList = async (
  ...
  const response = await get(
    `/commissions/admin-paid-commissions?page=${page}&sortBy=${sortBy}&sortOrder=${sortOrder}&search=${search}&limit=${recordsPerPage}`
  );
  return response;
};

const AdminPaidCommissionList = () => {
...
export default AdminPaidCommissionList;
